"""Réserve — le parcours de la démo en boucle, captures FR (plan B réseau).

Demande NG (2026-09-07) : deux diaporamas automatiques en annexe backup, un
par série de captures — celui-ci projette TOUJOURS la série FR, quelle que
...
``static/images/slideshows/demo-use/fr/``, 4 s par capture, fondu CSS,
...
_SERIES = "fr"
_MARKER = {"en": "Backup: demo loop (FR)", "fr": "Secours : démo en boucle (FR)"}
_TITLE = {"en": ("Demo backup — ", (s.project.titles.keyword, "French captures")),
          "fr": ("Secours démo — ", (s.project.titles.keyword, "captures françaises"))}
