...
#: titre et la sous-ligne restent propres à ce deck.
_TITLE = {"en": ("Where all of this ", (s.project.titles.keyword, "comes from")), "fr": ("La séance et ", (s.project.titles.keyword, "ses sources"))}
_LEAD = {"en": "every rule and claim of this session, with its source — the guidelines themselves first", "fr": "chaque règle et chaque affirmation de cette séance, avec sa source — les lignes directrices elles-mêmes d’abord"}
