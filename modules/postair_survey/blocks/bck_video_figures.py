"""Meet the figures 1/2 — le duo vidéo, la GAUCHE se lance (Einstein).

Première des deux pages jumelles du duo figures (gabarit
``custom/media_duo.py``, NG 2026-08-22) : Albert Einstein à gauche, Ada
Lovelace à droite — un homme, une femme, les deux noms les plus sûrs devant
l'assemblée. Vidéos de présentation servies depuis le CDN (doctrine du
...
SPEAKER NOTES:
Same gesture as the mascots: let Einstein speak, then arrow right for Ada
