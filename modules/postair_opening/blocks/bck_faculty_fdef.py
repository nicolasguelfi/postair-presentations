...
_MARKER = {"en": "FDEF"}
_FACULTY = {"en": "Law, Economics and Finance"}
...
_EXAMPLES = [
    {
        "headline": {"en": "AI -> −24.7 % crime, same jailing rate"},
    ...
    {
        "headline": {"en": "the model follows precedent — the judges followed sympathy"},
    ...
    {
        "headline": {"en": "Legal AI tools still invent case law"},
    ...
    {
        "headline": {"en": "Better inside the frontier, worse outside"},
