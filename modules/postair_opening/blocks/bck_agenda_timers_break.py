"""APPENDIX · Chronos pause — bloc mince, LA CONFIG VIT ICI.
...
JSON optionnel ``timers-break.json`` (static/data/, absent = silence) se relit à
...
def build(lang: str = "en", **_):
    build_timer_slide(1, lang,
                      tuning=st_tuning(DEFAULTS, local=LOCAL,
                                       json_path="data/timers-break.json"))
