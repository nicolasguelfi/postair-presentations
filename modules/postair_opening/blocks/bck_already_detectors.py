...
_VALUE = "61 %"
_CLAIM = "of essays by non-native writers are detected as AI"
_COUNTERPOINT = "the vendors report under 1 %"
_ATTRIBUTION = "Patterns, July 2023"
...
_POPULATION = ("91 human-written TOEFL essays by non-native English writers, "
               "against 88 essays by US eighth-graders which the same "
               "detectors classified almost perfectly")
_TREND = ("42 % of students say fear of being accused of cheating makes them "
          "less likely to use AI at all, down from 53 % a year earlier "
          "(HEPI 2026)")
_FRESHNESS = ("Three years old and still load-bearing: the peer-reviewed "
              "position in 2026 is unchanged. Detection is a fast-moving "
              "field — re-check before citing this in any policy document.")
_COUNTERPOINT_LONG = ("The vendors dispute it. Turnitin reports a "
...
_CAVEAT = ("The authors call it a pilot on small samples, and most detectors "
