...
TUNING: dict = {
    ...
    # cartes) : arguments_a = la slide de Ouverture, arguments_b = celle de
    # Résistance. Sur une slide, les 3 cartes partagent UN SEUL zoom (règle NG
    ...
    "arguments_a": {                # Ouverture (accélérateur)
    ...
    "arguments_b": {                # Résistance (ralentisseur)
        "zoom": None,                  # auto : min(240, palier 130/120/110 selon le titre le plus long) ; un absolu passe outre le plafond
        "zoom_scale": None,
        "badge_scale": None,           # facteur du badge de nature (None = taille du DS)
    },
