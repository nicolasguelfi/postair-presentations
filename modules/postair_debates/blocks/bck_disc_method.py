...
_TIP = [
    ...
    ({"en": "Past, present, future", "fr": "Passé, présent, futur"},
     {"en": ("Each axis runs the same way: the two poles and their statements, then the "
             "debate on stage — where this room stands — then the material: who held this "
             "posture before us and in what words, and what is argued today with sources."), "fr": "Chaque axe se déroule de la même façon : les deux pôles et leurs énoncés, puis le débat sur scène — où cette salle se situe — puis le matériau : qui a tenu cette posture avant nous, et en quels mots ; ce qui s'argumente aujourd'hui, avec des sources."}),
    ({"en": "On stage", "fr": "Sur scène"},
     {"en": ("Libero, the mascot of the Freedom pole; Medio, the moderator mascot; and your "
             "host — the speaker, whose portrait was generated by AI from his photographs, "
             "hence the ✦ AI mark."), "fr": "Libero, la mascotte du pôle Liberté ; Medio, la mascotte modératrice ; et votre hôte — l'orateur, dont le portrait a été généré par IA à partir de ses photographies, d'où la pastille ✦ AI."}),
    ({"en": "The ✦ AI mark", "fr": "La pastille ✦ AI"},
     {"en": ("On every image of this deck, the ✦ AI mark means the image was generated or "
             "altered by AI (the disclosure required by article 50 of the EU AI Act). The "
             "quotations, references and figures' names are never generated."), "fr": "Sur chaque image de ce deck, la pastille ✦ AI signifie que l'image a été générée ou modifiée par IA (la mention exigée par l'article 50 du règlement européen sur l'IA). Les citations, références et noms des figures ne sont jamais générés."}),
