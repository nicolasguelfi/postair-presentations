...
_MARKER = {"en": "From the dynamo to the atom", "fr": "De la dynamo à l'atome"}
_TITLE = {"en": ("From the dynamo to the ", (s.project.titles.keyword, "atom")), "fr": ("De la dynamo à l'", (s.project.titles.keyword, "atome"))}
