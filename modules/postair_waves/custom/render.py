...
_UI = {
    "wave_line": {"en": "{order} · {name}", "fr": "{order} · {name}"},
    "wave_line_period": {"en": "{order} · {name} · {period}", "fr": "{order} · {name} · {period}"},
    "figures_line": {"en": "{period} — {figures}", "fr": "{period} — {figures}"},
    "tooltip_detail": {"en": "{period} — figures: {figures}.", "fr": "{period} — figures : {figures}."},
    "tooltip_substitution": {"en": " Substitution term: “{subst}”.", "fr": " Terme de substitution : « {subst} »."},
    "tooltip_verbatim": {
        "en": " The questionnaire applies verbatim (this is the studied wave).", "fr": " Le questionnaire s'applique tel quel (c'est la vague étudiée)."},
    "full_lines": {"en": "{marker} — the full lines", "fr": "{marker} — les lignes complètes"},
    "full_line": {"en": "{marker} — the full line", "fr": "{marker} — la ligne complète"},
    "all_waves": {"en": "🌊 all waves", "fr": "🌊 les vagues"},
    "witness_of": {"en": "a witness of ", "fr": "témoin de la vague : "},
    "media_pending": {"en": "portrait and video pending at the hub", "fr": "portrait et vidéo en attente côté hub"},
    "lesson_before": {"en": "What ", "fr": "Ce que nous apprend « "},
    "lesson_after": {"en": " teaches us", "fr": " »"},
    "lesson_label": {"en": "The lesson", "fr": "La leçon"},
    "feared": {"en": "What was feared", "fr": "Ce qu'on craignait"},
    "came_of_it": {"en": "What came of it", "fr": "Ce qu'il en est advenu"},
    "echo": {"en": "The echo for AI", "fr": "L'écho pour l'IA"},
}
